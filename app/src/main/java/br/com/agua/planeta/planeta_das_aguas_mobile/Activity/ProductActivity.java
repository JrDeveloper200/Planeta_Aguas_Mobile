...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (singleProduct != null) {
            ...
            productPrice.setText("Preço:" + "R$ " + String.valueOf(new Double(singleProduct.getProductPrice()).doubleValue()));
            productDescription.setText(Html.fromHtml("<strong>Descrição do Produto</strong><br/>" + singleProduct.getProductDescription()));
